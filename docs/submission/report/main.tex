...
% Heading formatting per syllabus: chapter 16pt (centred, UPPERCASE),
% section 14pt, subsection / subsubsection 12pt, all bold.
...
% Captions: bold, colon separator, centred (figures below, tables above).
...
% Page number centred in the footer, no header rule (syllabus style).
\pagestyle{fancy}
\fancyhf{}
\fancyfoot[C]{\thepage}
...
% Keep the short List of Tables on the same page as List of Figures.
\begingroup
\let\clearpage\relax
\listoftables
\endgroup
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.50\textwidth]{methodology.png}
...
The system is modelled using standard UML and process diagrams. The \textbf{order processing
flow} in Figure~\ref{fig:flow} shows the lifecycle of an order from creation to billing.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.55\textwidth]{01-login.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.62\textwidth]{02-dashboard.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.60\textwidth]{architecture.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.82\textwidth]{deployment.png}
...
\par\vspace{4mm}
% Non-floating image grid so screenshots flow and break naturally (no blank float pages).
\newcommand{\appshot}[2]{%
  \begin{minipage}[t]{0.44\textwidth}
    \centering
    \includegraphics[width=\linewidth]{#1}\\[1mm]
    \footnotesize\captionof{figure}{#2}
  \end{minipage}}

\begin{center}
\appshot{03-menu.png}{Menu management}\hspace{6mm}%
\appshot{04-orders-new.png}{Order builder (new order)}

\vspace{5mm}
\appshot{06-billing.png}{Billing and itemised bill preview}\hspace{6mm}%
\appshot{07-inventory.png}{Inventory management}

\vspace{5mm}
\appshot{08-reports.png}{Reports and analytics}\hspace{6mm}%
\appshot{09-staff.png}{Staff management}
\end{center}
